...
*   **Schemes**:
    ...
    2. [HDFC Flexi Cap Fund (Equity Fund)](https://groww.in/mutual-funds/hdfc-equity-fund-direct-growth)
...
*   **Data Source**: Direct ingestion from Groww fund pages (No official PDF sourcing in the initial phase).
